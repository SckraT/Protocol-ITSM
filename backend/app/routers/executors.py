...
async def create_executor(body: ExecutorCreate, db: AsyncSession = Depends(get_db)):
...
async def update_executor(executor_id: int, body: ExecutorUpdate, db: AsyncSession = Depends(get_db)):
